...
public class SandwichApp {
    ...
    public static void main(String[] args) {
       ...
       //calculate the discount based on user Age Input
        ...
        float discountAmount = basePrice * discount /100;  // base price is different depends on the user sandwich choice


        System.out.println("Base Price: $" + basePrice);
        System.out.println("Discount: $"+ discountAmount);
        System.out.println("Final Price : $" + (basePrice - discountAmount));
